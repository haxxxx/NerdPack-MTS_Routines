...
local _Survival = {
	...
	{ "48792", (function() return NePCR.dynEval("player.health <= " .. NeP.Interface.fetchKey('NePConfDkUnholy', 'IceboundFortitude')) end) }, -- Icebound Fortitude
	{ "48743", (function() return NePCR.dynEval("player.health <= " .. NeP.Interface.fetchKey('NePConfDkUnholy', 'DeathPact')) end) }, -- Death Pact
	{ "108196", (function() return NePCR.dynEval("player.health <= " .. NeP.Interface.fetchKey('NePConfDkUnholy', 'DeathSiphon')) end) },-- Death Siphon
	...
	{ "49998", { -- Death Strike With Dark Succor
		"player.buff(10156)", 
		(function() return NePCR.dynEval("player.health <= " .. NeP.Interface.fetchKey('NePConfDkUnholy', 'DeathStrikeDS')) end)
	}}, 
}
